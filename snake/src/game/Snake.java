...
public class Snake {
	...
	public static Poison poisonzwei = new Poison();
	public static Poison poisondrei = new Poison();
	public static Poison poisonvier = new Poison();
	public static Poison poisonfünf = new Poison();
